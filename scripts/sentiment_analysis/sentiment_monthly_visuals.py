...
monthly_sentiment['date'] = pd.to_datetime(dict(year=monthly_sentiment.year,
                                                month=monthly_sentiment.month,
                                                day=[1] * len(monthly_sentiment)))
monthly_sentiment.set_index(monthly_sentiment['date'], inplace=True)
monthly_sentiment.drop(['year', 'month', 'date'], axis=1, inplace=True)
